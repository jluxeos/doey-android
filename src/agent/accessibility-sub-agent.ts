...
export async function runAccessibilitySubAgent(
  ...
  const systemPrompt = `You are an Accessibility Sub-Agent for the Doey AI assistant.
...
Please achieve the goal: ${goal}`;
  ...
  const updatedSystemPrompt = `You are an Accessibility Sub-Agent for the Doey AI assistant.
Your job is to control the Android UI of the app "${packageName}" to achieve a specific goal.
